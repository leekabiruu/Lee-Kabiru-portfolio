...
The look is pulled from your flier: navy/cream/blue/gold palette, the browser-chrome (dots + url bar) motif reused on the hero and every project card, and monospace type for anything "technical" (urls, contact info, labels).
...
json
"homepage": "https://leekabiruu.github.io/Lee-Kabiru-portfolio",
"scripts": {
